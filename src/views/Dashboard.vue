<template>
  <main
    class="flex justify-center items-center w-screen min-h-screen md:h-screen bg-slate-100 text-sm"
  >
    ...
    <article
      v-else
      class="bg-white w-screen min-h-screen md:min-h-0 md:w-[400px] md:h-[300px] flex flex-col md:overflow-auto scrollbar-vertical"
    >
